...
function Load_Home_Screen() {
    ...
    //SCE ( System App for Laptop, Desktop and Notepad ) ==>
...
function User_Installed_Apps() {
    ...
    const AppLogos = [
        ...
        '../Icons/iMobile_Pay.ico', '../Icons/PayTM.ico',  '../Icons/WhatsApp.ico', '../Icons/Tata_Play.ico',

        '../Icons/eVote.ico', '../Icons/Family_Link.ico', '../Icons/Chrome.ico'
